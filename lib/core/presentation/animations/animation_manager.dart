...
class AnimationManager {
  ...
  Widget applySuccessPop(Widget child) {
    return child.animate()
      .scale(begin: const Offset(0.8, 0.8), end: const Offset(1.1, 1.1), duration: 200.ms, curve: Curves.easeOutBack)
      .then()
      .scale(end: const Offset(1.0, 1.0), duration: 150.ms, curve: Curves.easeInOut);
  }
